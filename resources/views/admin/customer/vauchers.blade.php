    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <div class="col-md-4">
          <h3 class="box-title">All Expenditure Voucher</h3>
        </div>
        <div class="col-md-4">
          ...
          <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12">
            ...
            <thead>
              <tr role="row">
               ...
               <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">Genereted By</th>
            ...
            <tbody id="customerdata">
              ...
              <tr role="row" class="odd">
                ...
                <td> <?php $user=App\User::find($vaucher->user_id); echo $user->name; ?></td>
