...
<li class="breadcrumb-item active" aria-current="page">फिर्ता प्रकृया प्रारम्भ</li>
@endsection
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" name="return_remarks" id="return_remarks" placeholder="ग्राहक फिर्ताको कारण  प्रष्ट हुनेगरि अनिवार्य रुपमा उल्लेख गर्नुहोस् | " required></textarea>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $("#submit_btn").click(function(e) {
            ...
            $.ajax({
                ...
                url: '{{url("customers/postReturned")}}/{{$customer->id}}',
