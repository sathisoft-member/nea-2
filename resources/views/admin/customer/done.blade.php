...
<li class="breadcrumb-item active" aria-current="page">सम्पन्न ग्राहक विवरण</li>
@endsection
@section('content')
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="{{ url('/customers/getCompleted') }}/{{$customer->id}}"> <i class="fa fa-paper-plane text-green"></i>Complete</a>
                                                            </li>
                                                            <li>
