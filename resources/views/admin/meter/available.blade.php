...
<li class="breadcrumb-item active" aria-current="page">मिटर मौजदात विवरण</li>
@endsection
@section('content')
                      ...
                      <tbody id="meterdata">
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td>
                            ...
                            <a class="btn btn-danger btn-sm" onclick="confirmDelete('{{$meter->id}}')"><i class="fa fa-trash"></i></a>
