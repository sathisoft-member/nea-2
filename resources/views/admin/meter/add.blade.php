...
<li class="breadcrumb-item active" aria-current="page">नयाँ मौजदात दर्ता</li>
@endsection
@section('content')
  ...
  <div class="box-body">
    ...
    <div>
      ...
      <form id="meterForm" class="form-validate-jquery" method="post" action="javascript:void(0)">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select name="meter_type" class="form-control" id="meter_type" required>
                  <option value="0">Whole Current</option>
                  <option value="1">Demand Meter</option>
                </select>
          ...
          <div class="col-md-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="meter_company" id="meter_company" required>
              </div>
          ...
          <div class="col-md-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="meter_capacity" id="meter_capacity" required>
                <div class="input-group-addon">
                  AMP
                </div>
              </div>
          ...
          <div class="col-md-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" name="meter_voltage" id="meter_voltage" required>
              </div>
          ...
          <div class="col-md-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" name="meter_resulation" id="meter_resulation" required>
              </div>
          ...
          <div class="col-md-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" id="meter_digit" name="meter_digit" required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select name="meter_type_electro" class="form-control" id="meter_type_electro" required>
                  ...
                  <option value="1">Electro Mechanical</option>
                </select>
              </div>
          ...
          <div class="col-md-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" id="meter_decimal" name="meter_decimal" value="" required>
              </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input type="text" class="form-control " id="nepaliDate3" name="mfg_date" required>
              </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="meter_serial_number" id="meter_serial_number" required>
              </div>
            </div>
            <span style="color:red; " id="meter_serial_number_err"></span>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              <label>MF </label>
              <div class="input-group">
                ...
                <input type="number" class="form-control" name="meter_manufacture" id="meter_manufacture" required>
              </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" name="initial_reading" id="initial_reading" required>
              </div>
        ...
        <div class="form-group">
          <input type="submit" id="btn_submit" class="btn_sub btn btn-success" name="submit" value="Save">
...
<script>
  $(document).ready(function() {
    ...
    $('#btn_submit').click(function(event) {
      ...
      var url = '<?php echo url('meter/store'); ?>'
      $.ajax({
        url: url,
        method: 'POST',
        data: data,
